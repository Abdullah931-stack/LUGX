...
// ==========================================
// CodeMirror 6 Streaming Ghost Implementation
// ==========================================
import { StateField, StateEffect, RangeSetBuilder } from '@codemirror/state';
import { EditorView as CMEditorView, Decoration as CMDecoration, WidgetType as CMWidgetType } from '@codemirror/view';
...
export const codeMirrorStreamingGhostField = StateField.define<StreamingGhostState>({
    ...
    update(value, tr): StreamingGhostState {
        ...
        // Dynamic Position Shifting: map positions forward/backward for existing active decorations
