...
export const MODEL_CONFIG = {
    correct: {
        // Correct: lighter stable model for Free (budget + latency),
        // latest flash-lite for paid tiers (better quality).
    ...
    improve: {
        // Improve: stable 2.5-flash-lite for Free, newer preview model
        // for paid tiers to deliver higher-quality output.
        free: "gemini-2.5-flash-lite",
    ...
    translate: {
        // Translate: stable 2.5-flash-lite for Free, newer preview model
        // for paid tiers.
        free: "gemini-2.5-flash-lite",
        pro: "gemini-3-flash-preview",
        ultra: "gemini-3-flash-preview",
